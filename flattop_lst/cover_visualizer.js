...
files = [
	['flattop LST bag 1 cover.csv'], // bag 1
	['flattop LST bag 2 cover.csv', "flattop LST bag 2 minimals cover.csv"], // bag 2
	['box bag 3.csv', 'box alternative bag 3.csv', 'j spin build bag 3.csv',
        'B bag 3.csv', 'C bag 3.csv', 'D bag 3.csv',
        'mL IJLO thing bag 3.csv', 'skull emoji path bag 3.csv'], // bag 3
];
