...
data = [[], [], []];
setup = ['v115@vhAAgH', 'v115@vhAAgH', 'v115@vhAAgH', 'v115@vhAAgH', 'v115@vhAAgH'];
files = [
	['bt bag 1 cover.csv'], // bag 1
	['bt bag 2 cover.csv'], // bag 2
	['bt bag 3 cover.csv'], // bag 3
    [
		'bt bag 4 path 1 cover.csv',
		'bt bag 4 path 2 cover.csv',
    ], // bag 4
    [
		'bt bag 5 1-1 cover.csv',
        'bt bag 5 1-2 cover.csv',
        'bt bag 5 1-3 cover.csv',
        'bt bag 5 1-4 cover.csv',
        'bt bag 5 1-5 cover.csv',
        'bt bag 5 2-1 cover.csv',
        'bt bag 5 2-2 cover.csv',
        'bt bag 5 2-3 cover.csv',
        'bt bag 5 2-4 cover.csv',
        'bt bag 5 2-5 cover.csv',
