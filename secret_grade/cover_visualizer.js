...
files = [
	['secret grade bag 1 cover.csv'], // bag 1
	['secret grade bag 2 cover.csv'], // bag 2
	['secret grade bag 3 cover.csv'], // bag 3
    ['secret grade bag 4 cover.csv'], // bag 4
    ['secret grade bag 5 cover.csv'], // bag 5
    ['secret grade bag 6 cover.csv'], // bag 6
    ['secret grade bag 7 cover.csv'], // bag 7
    ['secret grade bag 8 cover.csv'], // bag 8
    ['secret grade bag 9 cover.csv'], // bag 9
	['secret grade bag 10 cover.csv'], // bag 10
];
...
async function preloadSetups() {
    ...
    await loadIncludedFile(3);
    await loadIncludedFile(4);
    await loadIncludedFile(5);
    await loadIncludedFile(6);
    await loadIncludedFile(7);
    await loadIncludedFile(8);
    await loadIncludedFile(9);
	await loadIncludedFile(10);
