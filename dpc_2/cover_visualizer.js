...
DPC_files = {
    ...
    L: ['L-001.csv', 'L-002.csv', 'L-003.csv', 'L-004.csv', 'L-005.csv', 'L-006.csv', 'L-007.csv', 'L-008.csv', 'L-009.csv', 'L-010.csv', 'L-011.csv', 'L-012.csv', 'L-013.csv', 'L-014.csv', 'L-015.csv', 'L-016.csv', 'L-017.csv', 'L-018.csv', 'L-019.csv', 'L-020.csv', 'L-021.csv', 'L-022.csv', 'L-023.csv', 'L-024.csv', 'L-025.csv', 'L-026.csv', 'L-027.csv', 'L-028.csv', 'L-029.csv', 'L-030.csv', 'L-031.csv', 'L-032.csv', 'L-033.csv', 'L-034.csv', 'L-035.csv', 'L-036.csv', 'L-037.csv', 'L-038.csv', 'L-039.csv', 'L-040.csv', 'L-041.csv', 'L-042.csv', 'L-043.csv', 'L-044.csv', 'L-045.csv', 'L-046.csv', 'L-047.csv', 'L-048.csv', 'L-049.csv', 'L-050.csv', 'L-051.csv', 'L-052.csv', 'L-053.csv', 'L-054.csv', 'L-055.csv', 'L-056.csv', 'L-057.csv', 'L-058.csv', 'L-059.csv', 'L-060.csv', 'L-061.csv', 'L-062.csv', 'L-063.csv', 'L-064.csv', 'L-065.csv', 'L-066.csv', 'L-067.csv', 'L-068.csv', 'L-069.csv', 'L-070.csv', 'L-071.csv', 'L-072.csv', 'L-073.csv', 'L-074.csv', 'L-075.csv', 'L-076.csv', 'L-077.csv', 'L-078.csv', 'L-079.csv', 'L-080.csv', 'L-081.csv', 'L-082.csv', 'L-083.csv', 'L-084.csv', 'L-085.csv', 'L-086.csv'],
