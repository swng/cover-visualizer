...
files = [
	['honey cup bag 1 cover.csv'], // bag 1
	['honey cup bag 2 form A cover.csv', 'honey cup bag 2 form B cover.csv'], // bag 2
	[
		'honey cup bag 3 main cover.csv',
		'honey cup bag 3 compromise A cover.csv',
		'honey cup bag 3 compromise B cover.csv',
	], // bag 3
];
...
async function loadIncludedFile(bag_num) {
    ...
    if (bag_num == 3) {
        await fetch(url.slice(0, -4) + " nohold.csv") // may throw error if nohold cover data doesn't exist
            .then((r) => {
